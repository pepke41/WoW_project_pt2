...
<html>
  ...
  <body>
    ...
    <div class="full-page">
      <h1>Cataclysm</h1>
      <p>All seems well in Azeroth until Deathwing an evil Dragon Aspect comes to
      ...
      <div class="maps">
        <h2>Azeroth After The Shattering</h2>
        <img src="img/map_cata.jpg" alt="Azeroth map after Deathwing">
        <p class="caption"><sup>The swirl in the middle of the map is where the Earth was shattered by
        Deathwing, and how players can access the Deepholm Region to help the
        Earthen Ring and former Horde Warcheif Thrall repair the world</sup></p>
      </div>

      <h2>New Races</h2>
      <ul>
        <li>Goblins (Horde)</li>
        <li>Worgen (Alliance)</li>
      </ul>

      <h2>Lore</h2>
      <h3>A Long Time Ago</h3>
      <p>After the Old gods were locked away by the Titans and order was restored
      ...
      people of Azeroth and imprisoned in Deepholm.</p>
      <h3>Deathwing returns</h3>
      <p>Over many years of being trapped in Deepholm Deathwing slowly began to
      ...
      from Deepholm shook Azeroth to its core, and is known as the Shattering</p>
      <h3>New Members to the Horde and Alliance</h3>
      <h4>The Goblins</h4>
      <p>The Goblins are a technological group that for a long time were a part of
      ...
      accepted.</p>
      <h4>The Worgen</h4>
      <p>With Thrall gone his replacement Garrosh Hellscream decided that now was
      ...
      were welcomed to join the Alliance.</p>

      <h2>Raids</h2>
      <ul>
        <li><u>Baradin Hold</u>: Following the Second War, the ruined fortress of Baradin
          ...
          liberation of its forgotten horrors may be at hand.</li>
        <li><u>Blackwing Decent:</u> Nefarian and his warped attempts to create a new
          ...
          nature.</li>
        <li><u>Dragon Soul:</u> Forged by Deathwing during the War of the Ancients, the
          ...
          himself.</li>
        <li><u>Firelands:</u> The Firelands is the molten domain forged by the titans to
          ...
          Firelands from Azeroth's champions.<li>
        <li><u>Bastion of Twilight</u>: The Bastion of Twilight stands as a dark symbol
          ...
          and life.</li>
        <li><u>Throne of the Four Wings</u>: Al'Akir the Windlord's personal lair, the
          ...
          mysterious titan-forged Halls of Origination.</li>
      </ul>
      <h2>Music</h2>
      <iframe width="560" height="315" src="https://www.youtube.com/embed/k4Pberbn2po" frameborder="0" allowfullscreen></iframe>
    </div>
